...
lv_color_t buf_1[LCD_H * LCD_W / 2];
#elif defined ( __CC_ARM )  /* MDK ARM Compiler */
__attribute__((at(0x10000000))) lv_color_t buf_1[LCD_H * LCD_W / 2];
#elif defined ( __clang__ ) /* MDK ARM Compiler v6 */
__attribute__((section(".ARM.__at_0x10000000"))) lv_color_t buf_1[LCD_H * LCD_W / 2];
#elif defined ( __GNUC__ ) /* GNU Compiler */
lv_color_t buf_1[LCD_H * LCD_W / 2] __attribute__((section(".LVGLccm")));
...
void lv_port_disp_init(void)
{
    ...
    lv_disp_draw_buf_init(&disp_buf, buf_1, NULL, LCD_H * LCD_W / 2);
