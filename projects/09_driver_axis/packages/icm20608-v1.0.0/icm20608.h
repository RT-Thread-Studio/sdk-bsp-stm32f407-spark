...
{
    ICM20608_GYROSCOPE_RANGE0, // 卤250dps
    ICM20608_GYROSCOPE_RANGE1, // 卤500dps
    ICM20608_GYROSCOPE_RANGE2, // 卤1000dps
    ICM20608_GYROSCOPE_RANGE3, // 卤2000dps
};
typedef enum icm20608_gyroscope_range icm20608_gyro_range_t;

enum icm20608_accelerometer_range
{
    ICM20608_ACCELEROMETER_RANGE0, // 卤2g
    ICM20608_ACCELEROMETER_RANGE1, // 卤4g
    ICM20608_ACCELEROMETER_RANGE2, // 卤8g
    ICM20608_ACCELEROMETER_RANGE3, // 卤16g
};
